...
# first_user = User.create!(name: 'Tom', photo: 'https://unsplash.com/photos', bio: 'Teacher from Mexico.')
# second_user = User.create!(name: 'Lilly', photo: 'https://unsplash.com/photos', bio: 'Teacher from Poland.')
